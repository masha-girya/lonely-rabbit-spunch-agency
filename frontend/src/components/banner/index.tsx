            ...
            {(state) => (
                <div className={styles.banner}>
                    ...
                    <div style={{width: '100%', height: '100%'}}>
                        ...
                        <div className={classNames(styles.banner__bannerContainer, `fade-banner-${state}`)}>
                            <div className={classNames(styles.banner__content, `slide-right-content-${state}`)}>
                                <h1>{title}</h1>
                            ...
                            <div className={styles.smokeElement}>
                                <div className={classNames(styles.smokeContainer, styles.smokeContainer_first)}>
                                    <div className={styles.smoke}>
                                        <img className={styles.smoke__item} src={smokeFloorImg.src}/>
                                    </div>
                                    <div className={styles.smoke}>
                                        <img className={styles.smoke__item2} src={smokeFloorImg.src}/>
                                    </div>
                                    <div className={styles.smoke}>
                                        <img className={styles.smoke__item3} src={smokeFloorImg.src}/>
                                    </div>
                                </div>
                            </div>
                            <div className={styles.smokeElement}>
                                <div className={classNames(styles.smokeContainer, styles.smokeContainer_second)}>
                                    <div className={styles.smoke}>
                                        <img className={styles.smoke__item} src={smokeFloorImg.src}/>
                                    </div>
                                    <div className={styles.smoke}>
