...
export const VideoBlock = () => {
  ...
  const [description, setDescription] = useState([
    'Brave confronting your demons as they awaken in a world of darkness and terror. In the game "Midnight Strikes" by Lonely Rabbit, you\'ll immerse into an uncharted realm, bridging science and fantasy. No one will believe you, and nothing can halt the malevolence.',
