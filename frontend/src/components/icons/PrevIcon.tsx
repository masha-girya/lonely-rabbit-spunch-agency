      ...
      <defs>
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_322_272"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_322_272"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_b_322_272"
          x="-12"
          y="-12"
          width="56"
          height="56"
