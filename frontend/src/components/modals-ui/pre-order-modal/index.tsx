...
export const PreOrderModal: React.FC<IPreOrderModal> = (props) => {
  ...
  const [text, setText] = useState(
    "Lorem ipsum dolor sit amet consectetu. Sit tellus ullamcorper arcu et velit erat massa sit. Duis orci tempor convallis massa."
  );
  const [releaseDate, setReleaseDate] = useState(
    "COMING SOON SEPTEMBER 10, 2023"
  );
  ...
  return (
    <div className={styles.preOrder}>
      <button
        className={styles.preOrder__closeBtn}
        type="button"
